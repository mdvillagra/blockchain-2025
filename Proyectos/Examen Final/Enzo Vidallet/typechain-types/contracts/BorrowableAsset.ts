...
export interface BorrowableAssetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface BorrowableAsset extends BaseContract {
  connect(runner?: ContractRunner | null): BorrowableAsset;
  waitForDeployment(): Promise<this>;

  interface: BorrowableAssetInterface;
